...
const translations: Record<Lang, Record<string, string>> = {
  ...
  "faq.intro": "Answers to the most common questions from our community.",
  "faq.q1": "How do I create an account?",
  "faq.a1": "Click Sign Up, fill in the required fields and confirm your email.",
  "faq.q2": "How do I become a model?",
  "faq.a2": "Visit the Become a Model page and complete the verification steps.",
  "faq.q3": "How can I upgrade to VIP?",
  "faq.a3": "Go to VIP Membership and choose the plan that fits you.",
  ...
  "faq.intro": "Risposte alle domande più comuni della community.",
  "faq.q1": "Come creo un account?",
  "faq.a1": "Clicca Registrati, compila i campi richiesti e conferma l'email.",
  "faq.q2": "Come divento una modella?",
  "faq.a2": "Visita la pagina Diventa Modella e completa i passaggi di verifica.",
  "faq.q3": "Come passo a VIP?",
  "faq.a3": "Vai a VIP Membership e scegli il piano adatto a te.",
...
export function I18nProvider({ children }: { children: ReactNode }) {
  ...
  const t = useMemo(() => (k: string) => translations[lang][k] ?? k, [lang]);
